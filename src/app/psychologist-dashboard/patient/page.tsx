    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#23270A] to-[#414719] p-4">
        ...
        <div className="text-center">
          ...
          <p className="text-[#5D601E]">Obteniendo los registros médicos...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#23270A] to-[#414719] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 p-6 bg-[#FEFCE9] rounded-2xl border border-[#C6B976] shadow-xl backdrop-blur-sm">
          <div>
            ...
            <p className="text-[#5D601E] mt-2 max-w-2xl">
              Gestión avanzada de pacientes con tecnología SanaTú. 
              Visualice, edite y administre toda la información de sus pacientes.
            </p>
          </div>
          
          <div className="mt-6 md:mt-0 flex items-center space-x-4">
            <div className="bg-[#F4F3E8] rounded-xl p-3 border border-[#C6B976]">
              <div className="text-sm text-[#5D601E]">Total pacientes</div>
              <div className="text-2xl font-bold text-[#23270A]">{patients.length}</div>
            </div>
          </div>
        </div>
        
        {/* Controles y filtros */}
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 p-6 bg-[#FEFCE9] rounded-2xl border border-[#C6B976] shadow-xl">
          <div className="relative w-full md:w-1/3">
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              <svg className="w-5 h-5 text-[#5D601E]" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPatients.map((patient) => (
            <div 
              key={patient.id}
              className="bg-gradient-to-br from-[#FEFCE9] to-[#23270A] rounded-2xl border border-[#C6B976] shadow-xl overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-2xl"
            >
              {/* Encabezado de tarjeta */}
              <div className="bg-gradient-to-r from-[#23270A] to-[#414719] p-5 border-b border-[#C6B976]">
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-r from-[#858735] to-[#5D601E] rounded-full flex items-center justify-center text-[#23270A] font-bold mr-4">
                    {patient.patientName.charAt(0)}
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-[#23270A]">{patient.patientName}</h3>
                    <div className="flex items-center mt-1">
                      <FaIdCard className="text-[#858735] mr-2" />
                      <span className="text-[#5D601E]">
              ...
              <div className="p-5">
                <div className="space-y-4">
                  <div className="flex">
                    <div className="w-1/2">
                      <div className="flex items-center mb-2">
                        <FaCalendarAlt className="text-[#858735] mr-2" />
                        <span className="text-[#5D601E] text-sm">Edad</span>
                      </div>
                      <div className="text-[#23270A] font-medium">
                        {patient.age || 'N/A'} años
                      </div>
                    </div>
                    <div className="w-1/2">
                      <div className="flex items-center mb-2">
                        <FaVenusMars className="text-[#858735] mr-2" />
                        <span className="text-[#5D601E] text-sm">Admisión</span>
                      </div>
                      <div className="text-[#23270A] font-medium">
                  ...
                  <div>
                    <div className="flex items-center mb-2">
                      <FaHospital className="text-[#858735] mr-2" />
                      <span className="text-[#5D601E] text-sm">EPS</span>
                    </div>
                    <div className="text-[#23270A] font-medium">
                  ...
                  <div>
                    <div className="flex items-center mb-2">
                      <FaMapMarkerAlt className="text-[#858735] mr-2" />
                      <span className="text-[#5D601E] text-sm">Ubicación</span>
                    </div>
                    <div className="text-[#23270A] font-medium">
                  ...
                  <div className="flex">
                    <div className="w-1/2">
                      <div className="flex items-center mb-2">
                        <FaPhone className="text-[#858735] mr-2" />
                        <span className="text-[#5D601E] text-sm">Teléfono</span>
                      </div>
                      <div className="text-[#23270A] font-medium">
                    ...
                    <div className="w-1/2">
                      <div className="flex items-center mb-2">
                        <FaEnvelope className="text-[#858735] mr-2" />
                        <span className="text-[#5D601E] text-sm">Email</span>
                      </div>
                      <div className="text-[#23270A] font-medium truncate">
                        {patient.email || 'N/A'}
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-[#C6B976]">
        ...
        {filteredPatients.length === 0 && (
          <div className="mt-12 text-center py-16 bg-[#FEFCE9] rounded-2xl border border-[#C6B976]">
            <div className="w-24 h-24 bg-gradient-to-r from-[#858735]/10 to-[#5D601E]/10 rounded-full flex items-center justify-center mx-auto mb-6">
              <FaUserInjured className="h-12 w-12 text-[#858735]" />
            </div>
            <h3 className="text-2xl font-bold text-[#23270A] mb-2">No se encontraron pacientes</h3>
            ...
            {searchTerm && (
              <button 
                ...
                className="mt-6 bg-gradient-to-r from-[#858735] to-[#5D601E] text-[#23270A] font-bold px-6 py-3 rounded-xl hover:from-[#5D601E] hover:to-[#858735] transition-all duration-300"
              >
                Limpiar búsqueda
              </button>
            )}
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-[#FEFCE9] to-[#23270A] rounded-2xl border border-[#C6B976] p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-[#FEFCE9] rounded-xl flex items-center justify-center mr-4 border border-[#C6B976]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#858735]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <div>
                <h3 className="text-[#5D601E] text-sm uppercase tracking-wider">Pacientes únicos</h3>
          ...
          <div className="bg-gradient-to-br from-[#FEFCE9] to-[#23270A] rounded-2xl border border-[#C6B976] p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-[#5D601E] text-sm uppercase tracking-wider">Edad promedio</h3>
                <p className="text-3xl font-bold text-[#23270A] mt-1">
                  {patients.length > 0 
      ...
      {editingPatient && (
        <div className="fixed inset-0 bg-[#23270A]/90 flex items-center justify-center z-50 p-4 backdrop-blur-md">
          <div className="bg-gradient-to-br from-[#FEFCE9] to-[#23270A] rounded-2xl border border-[#C6B976] shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-[#23270A]">Editar Paciente</h3>
                <button 
                  onClick={closeModals}
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[#5D601E] mb-2">Nombre completo</label>
                  <input
                    type="text"
                    name="patientName"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[#5D601E] mb-2">Tipo de identificación</label>
                    <select
                  ...
                  <div>
                    <label className="block text-[#5D601E] mb-2">Número de identificación</label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[#5D601E] mb-2">Fecha de nacimiento</label>
                    <input
                      type="date"
                      name="birthDate"
                  ...
                  <div>
                    <label className="block text-[#5D601E] mb-2">Edad</label>
                    <input
                      type="number"
                      name="age"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[#5D601E] mb-2">Teléfono</label>
                    <input
                      type="text"
                      name="phone"
                  ...
                  <div>
                    <label className="block text-[#5D601E] mb-2">Celular</label>
                    <input
                      type="text"
                      name="cellPhone"
                ...
                <div>
                  <label className="block text-[#5D601E] mb-2">Email</label>
                  <input
                    type="email"
                    name="email"
                ...
                <div>
                  <label className="block text-[#5D601E] mb-2">Dirección</label>
                  <input
                    type="text"
                    name="address"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-[#5D601E] mb-2">Ciudad</label>
                    <input
                      type="text"
                      name="city"
                  ...
                  <div>
                    <label className="block text-[#5D601E] mb-2">Departamento</label>
                    <input
                      type="text"
                      name="state"
                  ...
                  <div>
                    <label className="block text-[#5D601E] mb-2">Barrio</label>
                    <input
                      type="text"
                      name="neighborhood"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[#5D601E] mb-2">EPS</label>
                    <input
                      type="text"
                      name="eps"
                  ...
                  <div>
                    <label className="block text-[#5D601E] mb-2">Beneficiario</label>
                    <div className="mt-2">
                      <label className="inline-flex items-center">
                        <input
                          ...
                          onChange={handleEditChange}
                          className="form-checkbox h-5 w-5 text-[#858735] bg-[#F4F3E8] border-[#C6B976] rounded focus:ring-[#858735]"
                        />
                        <span className="ml-2 text-[#23270A]">Es beneficiario</span>
                      </label>
                    </div>
                  </div>
                </div>
            ...
            <div className="p-6">
              <div className="text-center">
                ...
                <p className="text-[#5D601E]">
                  ¿Estás seguro de que deseas eliminar al paciente <span className="font-bold text-[#23270A]">{patientToDelete.patientName}</span>? Esta acción no se puede deshacer.
                </p>
              </div>
