    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#23270A] to-[#414719] p-4">
        ...
        <div className="text-center">
          ...
          <p className="text-[#5D601E]">Obteniendo los registros clínicos...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#23270A] to-[#414719] p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 p-6 bg-[#FEFCE9] rounded-2xl border border-[#C6B976] shadow-xl backdrop-blur-sm">
          ...
          <div className="mt-6 md:mt-0 flex items-center space-x-6">
            <div className="flex items-center">
              <div className="w-5 h-5 bg-[#858735] rounded-full mr-2 shadow-sm shadow-[#858735]/50"></div>
              <span className="text-[#23270A] text-sm">Paciente</span>
            </div>
            <div className="flex items-center">
              <div className="w-5 h-5 bg-[#C6B976] rounded-full mr-2 border-2 border-[#858735]"></div>
              <span className="text-[#23270A] text-sm">Hoy</span>
            </div>
          </div>
        </div>
        
        {/* Panel principal */}
        <div className="bg-[#FEFCE9] rounded-2xl border border-[#C6B976] shadow-2xl overflow-hidden">
          {/* Controles del calendario */}
          <div className="flex items-center justify-between p-6 bg-gradient-to-r from-[#23270A] to-[#414719]">
            <button 
              onClick={goToPreviousMonth}
              className="flex items-center text-[#23270A] hover:text-[#858735] transition-colors group"
            >
              <div className="w-10 h-10 flex items-center justify-center bg-[#FEFCE9] rounded-full mr-3 group-hover:bg-[#858735]/10 transition-colors border border-[#C6B976]">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#858735] to-[#EBE0AE]">
            ...
            >
              ...
              <div className="w-10 h-10 flex items-center justify-center bg-[#FEFCE9] rounded-full ml-3 group-hover:bg-[#858735]/10 transition-colors border border-[#C6B976]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-7 gap-1 px-4 pt-4">
            {['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'].map(day => (
              <div 
                key={day} 
                className="p-3 text-center font-bold text-[#858735] bg-[#FEFCE9] rounded-lg border border-[#C6B976]"
              >
                {day}
              </div>
            ))}
              ...
              return (
                <div 
                  ...
                  className={`min-h-32 p-3 rounded-xl flex flex-col transition-all duration-300
                    ${isCurrentMonth 
                      ? 'bg-[#FEFCE9] border border-[#C6B976] hover:border-[#858735] hover:bg-[#EBE0AE] hover:shadow-lg hover:shadow-[#858735]/10' 
                      : 'bg-[#F4F3E8] border border-[#414719] text-[#858735]'} 
                    ${isToday ? 'bg-gradient-to-br from-[#FEFCE9] to-[#5D601E] border-2 border-[#858735] shadow-lg shadow-[#858735]/20' : ''}`}
                >
                  <div className={`text-right font-bold text-lg ${isToday ? 'text-[#858735]' : 'text-[#5D601E]'}`}>
                    {format(day, 'd')}
                  </div>
                  ...
                  <div className="mt-2 flex-grow overflow-y-auto max-h-28 custom-scrollbar">
                    {dayEvents.map(event => (
                      <div 
                        key={event.id} 
                        className="text-xs p-2 mb-2 rounded-lg bg-gradient-to-r from-[#5D601E] to-[#414719] text-[#23270A] truncate hover:from-[#858735] hover:to-[#5D601E] transition-all duration-300 transform hover:scale-[1.02] group"
                        title={event.patientName}
                      >
                        <div className="flex items-center">
                          <div className="w-2 h-2 bg-[#858735] rounded-full mr-2 group-hover:bg-[#FEFCE9] transition-colors"></div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-[#FEFCE9] to-[#23270A] rounded-2xl border border-[#C6B976] p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-[#5D601E] text-sm uppercase tracking-wider">Total de registros</h3>
                <p className="text-3xl font-bold text-[#23270A] mt-1">{events.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#FEFCE9] to-[#23270A] rounded-2xl border border-[#C6B976] p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-[#5D601E] text-sm uppercase tracking-wider">Registros hoy</h3>
                <p className="text-3xl font-bold text-[#23270A] mt-1">
        ...
        <div className="mt-10 text-center py-6 border-t border-[#C6B976]/30">
          <div className="flex items-center justify-center mb-4">
            <div className="w-8 h-8 bg-gradient-to-r from-[#858735] to-[#5D601E] rounded-full flex items-center justify-center mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#23270A]" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd" />
              </svg>
            </div>
            <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#858735] to-[#EBE0AE]">
