...
const CalendarDashboardPsychologist = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#f0f2f5] to-[#e4e7eb] p-4">
        ...
        <div className="text-center">
          ...
          <p className="text-[#6b7280]">Obteniendo los registros clínicos...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f0f2f5] to-[#e4e7eb] p-4">
        <div className="max-w-md w-full bg-white rounded-2xl border border-[#e5e7eb] shadow-xl p-8 backdrop-blur-sm">
          ...
          <button 
            ...
            className="w-full py-3 px-4 bg-gradient-to-r from-[#bec5a4] to-[#9fa68c] text-white font-bold rounded-xl hover:from-[#9fa68c] hover:to-[#bec5a4] transition-all duration-300 transform hover:scale-[1.02] shadow-lg shadow-[#bec5a4]/20"
          >
            Reintentar
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0f2f5] to-[#e4e7eb] p-4 md:p-8">
      {/* Encabezado premium */}
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 p-6 bg-white rounded-2xl border border-[#e5e7eb] shadow-xl backdrop-blur-sm">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#bec5a4] to-[#d4d9c2]">
          ...
          <div className="mt-6 md:mt-0 flex items-center space-x-6">
            ...
            <div className="flex items-center">
              <div className="w-5 h-5 bg-white rounded-full mr-2 border-2 border-[#bec5a4]"></div>
        ...
        <div className="bg-white rounded-2xl border border-[#e5e7eb] shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center justify-between p-6 bg-gradient-to-r from-[#f8f8f8] to-[#f0f0f0]">
            <button 
              onClick={goToPreviousMonth}
              className="flex items-center text-[#3a3a3a] hover:text-[#bec5a4] transition-colors group"
            >
              <div className="w-10 h-10 flex items-center justify-center bg-white rounded-full mr-3 group-hover:bg-[#bec5a4]/10 transition-colors border border-[#e5e7eb]">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#bec5a4] to-[#d4d9c2]">
            ...
            >
              ...
              <div className="w-10 h-10 flex items-center justify-center bg-white rounded-full ml-3 group-hover:bg-[#bec5a4]/10 transition-colors border border-[#e5e7eb]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-7 gap-1 px-4 pt-4">
            {['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'].map(day => (
              <div 
                key={day} 
                className="p-3 text-center font-bold text-[#bec5a4] bg-[#f8f8f8] rounded-lg border border-[#e5e7eb]"
              >
                {day}
              </div>
            ))}
              ...
              return (
                <div 
                  ...
                  className={`min-h-32 p-3 rounded-xl flex flex-col transition-all duration-300
                    ${isCurrentMonth 
                      ? 'bg-white border border-[#e5e7eb] hover:border-[#bec5a4] hover:bg-[#f8f8f8] hover:shadow-lg hover:shadow-[#bec5a4]/10' 
                      : 'bg-[#f8f8f8] border border-[#e5e7eb] text-[#9ca3af]'} 
                    ${isToday ? 'bg-gradient-to-br from-white to-[#f0f0f0] border-2 border-[#bec5a4] shadow-lg shadow-[#bec5a4]/20' : ''}`}
                >
                  <div className={`text-right font-bold text-lg ${isToday ? 'text-[#bec5a4]' : 'text-[#6b7280]'}`}>
                    {format(day, 'd')}
                  </div>
                  ...
                  <div className="mt-2 flex-grow overflow-y-auto max-h-28 custom-scrollbar">
                    {dayEvents.map(event => (
                      <div 
                        key={event.id} 
                        className="text-xs p-2 mb-2 rounded-lg bg-gradient-to-r from-[#f8f8f8] to-[#f0f0f0] text-[#3a3a3a] truncate hover:from-[#bec5a4] hover:to-[#9fa68c] hover:text-white transition-all duration-300 transform hover:scale-[1.02] group"
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-white to-[#f8f8f8] rounded-2xl border border-[#e5e7eb] p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center mr-4 border border-[#e5e7eb]">
              ...
              <div>
                <h3 className="text-[#6b7280] text-sm uppercase tracking-wider">Total de registros</h3>
          ...
          <div className="bg-gradient-to-br from-white to-[#f8f8f8] rounded-2xl border border-[#e5e7eb] p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-[#6b7280] text-sm uppercase tracking-wider">Pacientes únicos</h3>
          ...
          <div className="bg-gradient-to-br from-white to-[#f8f8f8] rounded-2xl border border-[#e5e7eb] p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-[#6b7280] text-sm uppercase tracking-wider">Registros hoy</h3>
                <p className="text-3xl font-bold text-[#3a3a3a] mt-1">
        ...
        <div className="mt-10 text-center py-6 border-t border-[#e5e7eb]/50">
          <div className="flex items-center justify-center mb-4">
            <div className="w-8 h-8 bg-gradient-to-r from-[#bec5a4] to-[#9fa68c] rounded-full flex items-center justify-center mr-3">
